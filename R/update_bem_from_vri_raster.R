...
correct_bem_from_vri <- function(vri_bem, beu_bec, clear_site_ma = TRUE, use_ifelse = TRUE,  raster_res = NULL) {
  ...
  vri_bem[beu_bec, on = .(merge_key = `BGC_Subzone`, BEUMC_S1 = `BEU`), `:=`(script_rule = `i.Script_Rule`, change_to_beu = `i.Change_to_BEU`)]
  ...
  vri_bem[beu_bec, on = .(merge_key = `BGC_Subzone`, BEUMC_S2 = `BEU`), `:=`(script_rule = `i.Script_Rule`, change_to_beu = `i.Change_to_BEU`)]
  ...
  vri_bem[beu_bec, on = .(merge_key = `BGC_Subzone`, BEUMC_S3 = `BEU`), `:=`(script_rule = `i.Script_Rule`, change_to_beu = `i.Change_to_BEU`)]
